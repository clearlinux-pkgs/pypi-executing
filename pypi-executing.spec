...
Source0  : https://files.pythonhosted.org/packages/8c/e3/7d45f492c2c4a0e8e0fad57d081a7c8a0286cdd86372b070cca1ec0caa1e/executing-2.1.0.tar.gz
...
%prep
%setup -q -n executing-2.1.0
cd %{_builddir}/executing-2.1.0
pushd ..
cp -a executing-2.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725210497
