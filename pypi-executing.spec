...
Source0  : https://files.pythonhosted.org/packages/0f/7e/6d9cd1b1484a75f638c7ca1ef717af5650c83b4c0f1b723fce845e9cd023/executing-0.9.1.tar.gz
...
%prep
%setup -q -n executing-0.9.1
cd %{_builddir}/executing-0.9.1
pushd ..
cp -a executing-0.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658942082
