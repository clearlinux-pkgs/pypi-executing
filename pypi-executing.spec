...
Source0  : https://files.pythonhosted.org/packages/95/96/f68d93c5d89d8c8966b12d89aff858bb33eac765296d2985363e16b5b8c5/executing-1.1.0.tar.gz
...
%prep
%setup -q -n executing-1.1.0
cd %{_builddir}/executing-1.1.0
pushd ..
cp -a executing-1.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664205761
