...
Source0  : https://files.pythonhosted.org/packages/91/50/a9d80c47ff289c611ff12e63f7c5d13942c65d68125160cefd768c73e6e4/executing-2.2.0.tar.gz
...
%prep
%setup -q -n executing-2.2.0
cd %{_builddir}/executing-2.2.0
pushd ..
cp -a executing-2.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737593737
