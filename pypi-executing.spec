...
Source0  : https://files.pythonhosted.org/packages/8f/ac/89ff37d8594b0eef176b7cec742ac868fef853b8e18df0309e3def9f480b/executing-1.2.0.tar.gz
...
%prep
%setup -q -n executing-1.2.0
cd %{_builddir}/executing-1.2.0
pushd ..
cp -a executing-1.2.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667226972
