...
Source0  : https://files.pythonhosted.org/packages/ca/e4/efb182548f9931b36b76fd9ba2236bfc5e6d342c905beff92e868afb5b5c/executing-0.8.2.tar.gz
...
%prep
%setup -q -n executing-0.8.2
cd %{_builddir}/executing-0.8.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642441053
...
cp %{_builddir}/executing-0.8.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/pypi-executing/44c582803d7005baacb1ad03bcc5ad393cbdd95f
