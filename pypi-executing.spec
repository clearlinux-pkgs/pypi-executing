...
Source0  : https://files.pythonhosted.org/packages/11/e3/207e956e01bd4a7809a1d7c4302fd2a64ab0b7a56c40711252a2d5d41ba7/executing-2.0.0.tar.gz
...
%prep
%setup -q -n executing-2.0.0
cd %{_builddir}/executing-2.0.0
pushd ..
cp -a executing-2.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696259690
