...
Source0  : https://files.pythonhosted.org/packages/7e/f7/148b1a293f8187b0ea5327be6ec595731bf2b0dde8d6dae9c907a1ecd704/executing-1.0.0.tar.gz
...
%prep
%setup -q -n executing-1.0.0
cd %{_builddir}/executing-1.0.0
pushd ..
cp -a executing-1.0.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661792454
