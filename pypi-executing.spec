...
Version  : 0.9.0
Release  : 7
URL      : https://files.pythonhosted.org/packages/a4/a3/a4708d1576f39a6cf769a15ab2ccef2390b03fbab69b0df7c457a199a87c/executing-0.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/a4/a3/a4708d1576f39a6cf769a15ab2ccef2390b03fbab69b0df7c457a199a87c/executing-0.9.0.tar.gz
...
%prep
%setup -q -n executing-0.9.0
cd %{_builddir}/executing-0.9.0
pushd ..
cp -a executing-0.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658764118
